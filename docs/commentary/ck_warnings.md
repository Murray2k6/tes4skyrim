...
**Code:** `asset_convert/character/modify_body_meshes.py`, `tes5_import/constants.py`, `tes5_import/dialog_converter.py`, `tes5_import/speaker_activators.py`
...
([modify_body_meshes.py](../../asset_convert/character/modify_body_meshes.py)) adds slot 44
