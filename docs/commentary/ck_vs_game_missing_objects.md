...
- [Why the two disagree at all](#why-two-disagree-all)
- [The cause: our own forced Persistent flag](#cause-our-own-forced-persistent)
- [Still open](#still-open)
- [Fixed on the way, but not the cause](#section)
- [What was ruled out, with counts](#what-was-ruled-out-with)
- [The rules this cost us](#rules-this-cost-us)
- [A leading space in a MODL path is not a bug](#leading-space-modl-path-not)
- [Tool bugs found while investigating](#tool-bugs)
- [Building on a 16 GB machine](#building-16-gb-machine)
...
<a id="cause-our-own-forced-persistent"></a>
...
<a id="what-was-ruled-out-with"></a>
...
<a id="leading-space-modl-path-not"></a>
...
documented in [python_tools.md](../reference/python_tools.md).

## Building on a 16 GB machine
<a id="building-16-gb-machine"></a>
...
## There is no "Show in World Map" record-header flag
<a id="no-show-in-world-map-flag"></a>
...
STATs and 70 TREEs.  See docs/commentary/ck_vs_game_missing_objects.md.
