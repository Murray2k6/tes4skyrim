...
7. **OBSE extensions**: SKSE64-backed input, settings, form/name/type, crosshair,
   and string functions convert mechanically. Heterogeneous `ar_*` arrays/maps
   and Oblivion XML menu paths still require authored restructuring.
