...
from .skyrim_overrides import VTYP_EDID_BY_FID
...
def import_plugin(export_dir: str, output_path: str, masters: list = None,
    ...
    # side uses (asset_convert/ui/book_inam.py).  Two BOOK models can share a
    ...
    # (shared algorithm in asset_convert/nif/furniture_markers.py).
    ...
    # each its own HDPT (asset_convert.character.hair_pipeline).  convert_HAIR needs to
    ...
    base_model_by_fid = navm_pool.build_base_model_index(by_type,
                                                         _navm_master_export)
    door_fids = navm_pool.build_door_fid_set(by_type, _navm_master_export)
    ...
    navm_cache = navm_pool.precompute_navmeshes(
