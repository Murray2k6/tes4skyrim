...
Usage:
    python tools/objective_text_extract.py --plugin Oblivion.esm
    python tools/objective_text_extract.py --plugin Oblivion.esm Nehrim.esm \
        --out temp/slots.json
    python tools/objective_text_extract.py --all --stats
"""
import argparse
import json
import os
