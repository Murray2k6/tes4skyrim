...
Usage:
    python tools/esm/esm_diff.py A.esm B.esm            # summary of all groups
    python tools/esm/esm_diff.py A.esm B.esm -g CELL    # detail one group
    python tools/esm/esm_diff.py A.esm B.esm --list-changed 20
"""
