...
really reads.
    ...
    python tools/papyrus_native_locate.py GetDialogueTarget --live
    python tools/papyrus_native_locate.py IsInDialogueWithPlayer --live --count 120
    python tools/papyrus_native_locate.py IsInMenuMode --live --follow 2
...
from skyrim_disasm import Binary, LiveBinary, DEFAULT_EXE  # noqa: E402
