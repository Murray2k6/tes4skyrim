...
`Actor` -- see docs/papyrus_conversion_notes.md.
    ...
    python tools/property_type_audit.py -f Oblivion.esm

    # audit an arbitrary directory of .psc (e.g. a subset rebuild)
    python tools/property_type_audit.py -f Oblivion.esm --src temp/arena_fix

    # also report which TES4 calls named each bad ref, to find the promoter
    python tools/property_type_audit.py -f Oblivion.esm --blame
