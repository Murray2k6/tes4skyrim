...
Usage:
    ...
    python tools/script/script_debug.py -f Morrowind_ob.esm --quest fbmwChargen
    ...
    python tools/script/script_debug.py -f Nehrim.esm --script TES4_MQ00Script

    python tools/script/script_debug.py -f Morrowind_ob.esm --revert
"""
import argparse
import os
import re
