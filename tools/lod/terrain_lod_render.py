...
tools/navmesh/render.py and tools/lod/spt_preview.py.

Usage:
  python tools/lod/terrain_lod_render.py --esm output/oblivion.esm/oblivion.esm \
      --worldspace TES4Tamriel --cell -8 -8 --radius 8 --out temp/lod_check.png
  # or a whole worldspace overview (downsampled):
  python tools/lod/terrain_lod_render.py --esm ... --overview --out temp/overview.png
"""
import argparse
import sys
