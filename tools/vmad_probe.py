...
Usage:
    python tools/vmad_probe.py output/Oblivion.esm/Oblivion.esm TES4_CGRenoteScript
    python tools/vmad_probe.py <esm> <script> --props
    python tools/vmad_probe.py <esm> <script> --types NPC_,ACHR
"""
import argparse
import mmap
import struct
