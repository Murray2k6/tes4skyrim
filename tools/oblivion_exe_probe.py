...
Motivation matches tools/oblivion_engine_extract.py: the only descriptions of
...
Usage:
    python tools/oblivion_exe_probe.py --exe <path> --str AddTopic
    python tools/oblivion_exe_probe.py --exe <path> --xref 0xa4f6e0
    python tools/oblivion_exe_probe.py --exe <path> --disasm 0x5c1234 --count 60
"""
import argparse
import struct
