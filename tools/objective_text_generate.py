...
Usage:
    python tools/objective_text_generate.py --slots temp/objective_slots.json \
        --out temp/objective_short.json
    python tools/objective_text_generate.py --slots ... --stats
    python tools/objective_text_generate.py --slots ... --review 40
"""
import argparse
import json
import os
...
def main():
    ...
    ap.add_argument("--slots", default="temp/objective_slots.json",
                    help="output of tools/objective_text_extract.py")
