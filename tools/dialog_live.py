...
Usage:
    python tools/dialog_live.py topics            # what is on offer right now
    python tools/dialog_live.py watch --seconds 300 --out log.txt
    python tools/dialog_live.py talk 1A032A18     # teleport + start conversation
    python tools/dialog_live.py say 1A032A18 CharGenMain
"""
...
def _bridge():
    from game_bridge import Bridge
