...
`tools/create_lod.py` bakes every plugin's distant LOD ONCE into a single
...
plugin and what `tools/package_start_mod.py` produces for the starter mod:
...
Usage:
  python tools/pack_lod.py             # -> output/Finished Mods/AutoConvertLOD.zip
  python tools/pack_lod.py --output-dir PATH
"""
