...
Usage:
    python tools/dialog/voice_line_table.py                       # summary
    python tools/dialog/voice_line_table.py --csv temp/voice_table.csv
    python tools/dialog/voice_line_table.py --npc Azzan           # one NPC, verbose
    python tools/dialog/voice_line_table.py --status MISSING INVALID
"""
