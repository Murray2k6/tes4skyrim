...
created, but it runs standalone against any notes file:
    ...
    python tools/discord_release_notify.py --notes notes.txt --tag 0.591 \
                                           --repo bryantmh/tes4skyrim
    python tools/discord_release_notify.py --notes notes.txt --tag 0.591 --dry-run
...
`navmesh-cache-*` releases from tools/navmesh_cache.py on a developer machine,
