...
Usage:
    python tools/creature/patch_body_slots.py "C:/.../Data/Skyrim.esm"
    python tools/creature/patch_body_slots.py Skyrim.esm Dawnguard.esm Dragonborn.esm MyArmorMod.esp
