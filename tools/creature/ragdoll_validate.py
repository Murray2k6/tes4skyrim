...
Usage:
    python tools/creature/ragdoll_validate.py <skeleton.nif> [...]
    python tools/creature/ragdoll_validate.py --creatures-dir export/Oblivion.esm/meshes/creatures dog deer bear
    python tools/creature/ragdoll_validate.py <skeleton.nif> -v      # per-joint detail even when OK
"""
