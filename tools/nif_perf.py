...
output, and compares against a stored baseline.
    ...
    python tools/nif_perf.py --save-baseline temp/nif_base.json --count 40

    # after a change: same sample, compares hashes and reports the speedup
    python tools/nif_perf.py --baseline temp/nif_base.json --count 40

    # find the hot kernel instead of timing
    python tools/nif_perf.py --profile --count 12 --top 25
